export const Icons = {
  groups: {
    ...
    class: 'mt-1 h-8 w-8 shrink-0 fill-blue-500 dark:fill-blue-300',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 shrink-0 fill-blue-500 hs-tab-active:fill-blue-500 dark:fill-blue-300 dark:hs-tab-active:fill-blue-300 md:h-7 md:w-7',
    fill: '#3b82f6',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  ...
  house: {
    ...
    class:
      'h-6 w-6 shrink-0 text-blue-500 hs-tab-active:text-blue-500 dark:text-blue-300 dark:hs-tab-active:text-blue-300 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  instagramFooter: {
    paths: [
      {
        d: 'M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.332 3.608 1.308.975.975 1.246 2.242 1.308 3.608.058 1.266.069 1.596.069 4.85s-.011 3.535-.069 4.85c-.062 1.366-.333 2.633-1.308 3.608-.975.975-2.242 1.246-3.608 1.308-1.315.058-1.596.069-4.85.069s-3.535-.011-4.85-.069c-1.366-.062-2.633-.333-3.608-1.308-.976-.975-1.246-2.242-1.308-3.608C2.175 15.535 2.163 15.204 2.163 12s.012-3.584.07-4.85c.062-1.366.332-2.633 1.308-3.608.975-.976 2.242-1.246 3.608-1.308C8.416 2.175 8.796 2.163 12 2.163Zm0 3.675a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324Zm0 10.162a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm6.406-10.405a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881Z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
  ...
  mediumFooter: {
    paths: [
      {
        d: 'M13.54 12a6.8 6.8 0 0 1-6.77 6.86A6.8 6.8 0 0 1 0 12a6.8 6.8 0 0 1 6.77-6.86A6.8 6.8 0 0 1 13.54 12Zm7.42 0c0 3.54-1.52 6.41-3.39 6.41S14.18 15.54 14.18 12s1.52-6.41 3.39-6.41S20.96 8.46 20.96 12Zm3.04 0c0 3.17-.54 5.74-1.2 5.74s-1.2-2.57-1.2-5.74.54-5.74 1.2-5.74S24 8.83 24 12Z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
  ...
  substackFooter: {
    paths: [
      {
        d: 'M3 2h18v2.8H3V2Zm0 5.2h18V10H3V7.2Zm0 5.2h18V22l-9-5-9 5v-9.6Z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
